...
pub(crate) fn register_lints(registry: &mut LintRegistryBuilder) {
    ...
    registry.register_lint(&REDUNDANT_BOOLEAN_TEST);
...
declare_lint! {
    #[doc = include_str!("../../resources/lint_docs/invalid-legacy-positional-parameter.md")]
    pub(crate) static REDUNDANT_BOOLEAN_TEST = {
        summary: "detects boolean tests that are always truthy or always falsey",
        status: LintStatus::stable("0.0.70"),
        default_level: Level::Warn,
    }
}
